...
export class ContainerResolver {
  ...
  async getContainerAddress(
    @Args() args,
    @Info() info,
  ): Promise<ContainerAddressMessage> {
    let response: ContainerAddressMessage = {
      status: 404,
      message: 'Failed: Container May Not_Exist/Not_Running/Has_No_PubliC_Port',
      url: '',
    };
